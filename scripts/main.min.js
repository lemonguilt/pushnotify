...
function promisifyRequest(e) {
    return new Promise(function(s, t) {
        ...
        function a() {
            e.removeEventListener("complete", i), e.removeEventListener("success", i), e.removeEventListener("error", n), e.removeEventListener("abort", n)
        }
...
function IndexDBWrapper(e, s, t) {
    ...
    this.ready = promisifyRequest(i), i.onupgradeneeded = function(e) {
    ...
    window.PushDemo.ui.setPushSwitchDisabled(!0), navigator.serviceWorker.ready.then(function(e) {
        e.pushManager.subscribe({
            ...
            "permissions" in navigator ? navigator.permissions.query({
                ...
                if (console.log("subscribe() Error: Push permission state = ", s), window.PushDemo.ui.setPushChecked(!1), "denied" === s.state) window.PushDemo.ui.showError("Ooops Notifications are Blocked", "Unfortunately you just permanently blocked notifications. Please unblock / allow them to switch on push notifications.");
                else {
                    if ("prompt" === s.state) return void window.PushDemo.ui.setPushSwitchDisabled(!1);
                    window.PushDemo.ui.showError("Ooops Push Couldn't Register", '<p>When we tried to get the subscription ID for GCM, something went wrong, not sure why.</p><p>Have you defined "gcm_sender_id" and "gcm_user_visible_only" in the manifest?</p><p>Error message: ' + e.message + "</p>"), window.PushDemo.ui.setPushSwitchDisabled(!1), window.PushDemo.ui.setPushChecked(!1)
                }
            })["catch"](function(e) {
                window.PushDemo.ui.showError("Ooops Push Couldn't Register", '<p>When we tried to get the subscription ID for GCM, something went wrong, not sure why.</p><p>Have you defined "gcm_sender_id" and "gcm_user_visible_only" in the manifest?</p><p>Error message: ' + e.message + "</p>"), window.PushDemo.ui.setPushSwitchDisabled(!1), window.PushDemo.ui.setPushChecked(!1)
...
function unsubscribeDevice() {
    window.PushDemo.ui.setPushSwitchDisabled(!0), navigator.serviceWorker.ready.then(function(e) {
        e.pushManager.getSubscription().then(function(e) {
            return e ? (console.log("Unsubscribe from push"), void e.unsubscribe().then(function(e) {
                console.log("Unsubscribed from push: ", e), e || console.error("We were unable to unregister from push"), window.PushDemo.ui.setPushSwitchDisabled(!1), window.PushDemo.ui.showGCMPushOptions(!1)
            })["catch"](function(e) {
                console.log("Unsubscribtion error: ", e), window.PushDemo.ui.setPushSwitchDisabled(!1), window.PushDemo.ui.showGCMPushOptions(!0), window.PushDemo.ui.setPushChecked(!0)
            })) : (window.PushDemo.ui.setPushSwitchDisabled(!1), window.PushDemo.ui.setPushChecked(!1), void window.PushDemo.ui.showGCMPushOptions(!1))
...
function permissionStateChange(e) {
    switch (console.log("permissionStateChange = ", e), e.state) {
        case "denied":
            window.PushDemo.ui.showError("Ooops Push has been Blocked", "Unfortunately the user permanently blocked push. Please unblock / allow them to switch on push notifications."), window.PushDemo.ui.setPushChecked(!1), window.PushDemo.ui.setPushSwitchDisabled(!0);
            break;
        case "granted":
            window.PushDemo.ui.setPushSwitchDisabled(!1);
            break;
        case "prompt":
            window.PushDemo.ui.setPushChecked(!1), window.PushDemo.ui.setPushSwitchDisabled(!1)
    }
}
...
function setUpPushPermission() {
    navigator.permissions.query({
        ...
        permissionStateChange(e), e.onchange = function() {
            permissionStateChange(this)
        }, navigator.serviceWorker.ready.then(function(e) {
            e.pushManager.getSubscription().then(function(e) {
                return e ? (window.PushDemo.ui.setPushChecked(!0), void onPushSubscription(e)) : void console.log("No subscription given")
            })["catch"](function(e) {
                console.log("An error occured while calling getSubscription()", e)
            })
        })
    })["catch"](function(e) {
        console.error(e), window.PushDemo.ui.showError("Ooops Unable to check the permission", "Unfortunately the permission for push notifications couldn't be checked. Are you on Chrome 43+?")
    })
}

function setUpNotificationPermission() {
    return "denied" === Notification.permission ? void window.PushDemo.ui.showError("Ooops Notifications are Blocked", "Unfortunately notifications are permanently blocked. Please unblock / allow them to switch on push notifications.") : "default" === Notification.permission ? (window.PushDemo.ui.setPushChecked(!1), void window.PushDemo.ui.setPushSwitchDisabled(!1)) : void navigator.serviceWorker.ready.then(function(e) {
        e.pushManager.getSubscription().then(function(e) {
            return e ? (window.PushDemo.ui.setPushChecked(!0), void onPushSubscription(e)) : (window.PushDemo.ui.setPushChecked(!1), void window.PushDemo.ui.setPushSwitchDisabled(!1))
        })["catch"](function(e) {
            console.log("An error occured while calling getSubscription()", e)
        })
    })
...
function initialiseState() {
    return "PushManager" in window ? "permissions" in navigator ? 
    void setUpPushPermission() : void setUpNotificationPermission() : 
    void window.PushDemo.ui.showError("Ooops Push Isn't Supported", 'If this isn\'t an expected error please get in touch with <a href="https://twitter.com/gauntface">@gauntface</a> as the demo is probably broken.')
}
...
function UIHandler() {
    ...
    n.disabled = !document.queryCommandSupported("copy"), n.addEventListener("click", function(e) {
        var s = document.querySelector(".js-curl-code"),
            t = document.createRange();
        t.selectNode(s), window.getSelection().addRange(t);
        try {
    ...
    }), new MaterialButton(n), this.getPushSwitchElement = function() {
        return e
...
function MaterialAnimation(e) {
    this.element_ = e, this.position_ = this.Constant_.STARTING_POSITION, this.moveable_ = this.element_.querySelector("." + this.CssClasses_.DEMO_JS_MOVABLE_AREA), this.init()
}
...
function MaterialTab(e, s) {
    if (e) {
        if (s.element_.classList.contains(s.CssClasses_.RIPPLE_EFFECT)) {
            ...
            t.classList.add(s.CssClasses_.RIPPLE_CONTAINER), t.classList.add(s.CssClasses_.RIPPLE_EFFECT);
            var i = document.createElement("span");
            i.classList.add(s.CssClasses_.RIPPLE), t.appendChild(i), e.appendChild(t)
        }
        e.addEventListener("click", function(t) {
            t.preventDefault();
            var i = e.href.split("#")[1],
                n = document.querySelector("#" + i);
            s.resetTabState_(), s.resetPanelState_(), e.classList.add(s.CssClasses_.IS_ACTIVE), n.classList.add(s.CssClasses_.IS_ACTIVE)
        })
    }
}
...
function MaterialLayoutTab(e, s, t, i) {
    if (e) {
        ...
        e.addEventListener("click", function(n) {
            ...
            i.resetTabState_(s), i.resetPanelState_(t), e.classList.add(i.CssClasses_.ACTIVE_CLASS), o.classList.add(i.CssClasses_.ACTIVE_CLASS)
        })
    }
}
...
IndexDBWrapperProto.transaction = function(e, s, t) {
    return this.ready.then(function(i) {
        var n = "readonly";
        s.apply ? t = s : s && (n = s);
        var a, o = i.transaction(e, n),
            r = t(o, i),
            l = promisifyRequest(o);
        return r ? (a = r[0] && "result" in r[0] ? Promise.all(r.map(promisifyRequest)) : promisifyRequest(r), l.then(function() {
            return a
        })) : l
    })
...
var API_KEY = "AIzaSyDz_yzUWcZvSnQ9vd-m1LMx3Hyw3Y28-Mg",
    PUSH_SERVER_URL = "https://lemonguilt.github.io/pushnotify";
window.addEventListener("UIReady", function() {
    var e = document.querySelector(".js-enable-push");
    e.addEventListener("change", function(e) {
        e.target.checked ? subscribeDevice() : unsubscribeDevice()
    }), "serviceWorker" in navigator ? navigator.serviceWorker.register("service-worker-sample.js", {
        scope: "./"
    ...
    window.PushDemo = window.PushDemo || {}, window.PushDemo.ui = new UIHandler;
...
var componentHandler = function() {
    function e(e, s) {
        for (var t = 0; t < o.length; t++)
            if (o[t].className === e) return void 0 !== s && (o[t] = s), o[t];
        return !1
    }
    ...
    function s(s, i) {
        ...
        for (var a = document.querySelectorAll("." + i), o = 0; o < a.length; o++) t(a[o], s)
    }

    function t(s, t) {
        var i = s.getAttribute("data-upgraded");
        if (null === i || -1 === i.indexOf(t)) {
            null === i && (i = ""), s.setAttribute("data-upgraded", i + "," + t);
            var n = e(t);
            n ? (r.push(new n.classConstructor(s)), n.callbacks.forEach(function(e) {
                e(s)
    ...
    function a() {
        for (var e = 0; e < o.length; e++) s(o[e].className)
    }
    var o = [],
        r = [];
    return {
...
window.addEventListener("load", function() {
...
}, MaterialAnimation.prototype.handleClick_ = function(e) {
    ...
    if (this.element_) {
        ...
        if (this.element_.classList.contains(this.CssClasses_.WSK_JS_RIPPLE_EFFECT)) {
            ...
            var t = document.createElement("span");
            t.classList.add(this.CssClasses_.WSK_RIPPLE), s.appendChild(t), t.addEventListener("mouseup", e), this.element_.appendChild(s)
        }
    ...
    e.disabled ? s.classList.add(this.CssClasses_.IS_DISABLED) : s.classList.remove(this.CssClasses_.IS_DISABLED), e.checked ? s.classList.add(this.CssClasses_.IS_CHECKED) : s.classList.remove(this.CssClasses_.IS_CHECKED)
    ...
    if (this.element_) {
        ...
        var t = document.createElement("span");
        t.classList.add(this.CssClasses_.TICK_OUTLINE), e.appendChild(t), this.element_.appendChild(s), this.element_.appendChild(e);
        var i;
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            ...
            var n = document.createElement("span");
            n.classList.add(this.CssClasses_.RIPPLE), i.appendChild(n), this.element_.appendChild(i), i.addEventListener("mouseup", this.onMouseUp_.bind(this))
        }
    ...
    if (this.element_)
        for (var e = 0; e < this.Constant_.INVISIBLE_WRAPPING_ELEMENT_COUNT; e++) {
            ...
            s.classList.add(this.CssClasses_.INVISIBLE_WRAPPING_ELEMENT), this.element_.appendChild(s)
        }
}, componentHandler.register({
    ...
    if (this.element_) {
        ...
        if (this.element_.classList.contains(this.CssClasses_.JS_RIPPLE_EFFECT)) {
            this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), e = document.createElement("span"), e.classList.add(this.CssClasses_.RIPPLE_CONTAINER), e.classList.add(this.CssClasses_.JS_RIPPLE_EFFECT), e.classList.add(this.CssClasses_.RIPPLE_CENTER);
            var s = document.createElement("span");
            s.classList.add(this.CssClasses_.RIPPLE), e.appendChild(s), this.element_.appendChild(e), e.addEventListener("mouseup", this.onMouseUp_.bind(this))
        }
        this.btnElement_.addEventListener("change", this.onChange_.bind(this)), this.btnElement_.addEventListener("focus", this.onFocus_.bind(this)), this.btnElement_.addEventListener("blur", this.onBlur_.bind(this)), this.element_.addEventListener("mouseup", this.onMouseUp_.bind(this)), this.updateClasses_(this.btnElement_, this.element_), this.element_.classList.add(this.CssClasses_.IS_UPGRADED)
    }
}, componentHandler.register({
    ...
    if (this.element_) {
        ...
        var s = document.createElement("span");
        s.classList.add(this.CssClasses_.WSK_RIPPLE), e.appendChild(s), this.element_.appendChild(e)
    }
}, componentHandler.register({
    ...
    for (var s = document.getElementsByClassName(this.CssClasses_.JS_RADIO), t = 0; t < s.length; t++) {
        ...
        i.getAttribute("name") === this.btnElement_.getAttribute("name") && this.updateClasses_(i, s[t])
    }
    ...
    if (this.element_) {
        ...
        var t;
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), t = document.createElement("span"), t.classList.add(this.CssClasses_.RIPPLE_CONTAINER), t.classList.add(this.CssClasses_.RIPPLE_EFFECT), t.classList.add(this.CssClasses_.RIPPLE_CENTER);
            var i = document.createElement("span");
            i.classList.add(this.CssClasses_.RIPPLE), t.appendChild(i), this.element_.appendChild(t), t.addEventListener("mouseup", this.onMouseup_.bind(this))
        }
        this.btnElement_.addEventListener("change", this.onChange_.bind(this)), this.btnElement_.addEventListener("focus", this.onFocus_.bind(this)), this.btnElement_.addEventListener("blur", this.onBlur_.bind(this)), this.element_.addEventListener("mouseup", this.onMouseup_.bind(this)), this.updateClasses_(this.btnElement_, this.element_), this.element_.classList.add(this.CssClasses_.IS_UPGRADED)
    }
}, componentHandler.register({
    ...
    e.target.blur()
}, MaterialSlider.prototype.updateValue_ = function(e) {
    ...
    var s = document.createElement("div");
    s.classList.add(this.CssClasses_.WSK_SPINNER_LAYER), s.classList.add(this.CssClasses_.WSK_SPINNER_LAYER + "-" + e);
    var t = document.createElement("div");
    t.classList.add(this.CssClasses_.WSK_SPINNER_CIRCLE_CLIPPER), t.classList.add(this.CssClasses_.WSK_SPINNER_LEFT);
    var i = document.createElement("div");
    i.classList.add(this.CssClasses_.WSK_SPINNER_GAP_PATCH);
    var n = document.createElement("div");
    n.classList.add(this.CssClasses_.WSK_SPINNER_CIRCLE_CLIPPER), n.classList.add(this.CssClasses_.WSK_SPINNER_RIGHT);
    for (var a = [t, i, n], o = 0; o < a.length; o++) {
        var r = document.createElement("div");
        r.classList.add(this.CssClasses_.WSK_SPINNER_CIRCLE), a[o].appendChild(r)
    }
    ...
    if (this.element_) {
        for (var e = 1; e <= this.Constant_.WSK_SPINNER_LAYER_COUNT; e++) this.createLayer(e);
    ...
    if (this.element_) {
        ...
        var t = document.createElement("span");
        t.classList.add(this.CssClasses_.FOCUS_HELPER), s.appendChild(t), this.element_.appendChild(e), this.element_.appendChild(s);
        var i;
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT)) {
            this.element_.classList.add(this.CssClasses_.RIPPLE_IGNORE_EVENTS), i = document.createElement("span"), i.classList.add(this.CssClasses_.RIPPLE_CONTAINER), i.classList.add(this.CssClasses_.RIPPLE_EFFECT), i.classList.add(this.CssClasses_.RIPPLE_CENTER);
            var n = document.createElement("span");
    ...
    for (var e = 0; e < this.tabs_.length; e++) this.tabs_[e].classList.remove(this.CssClasses_.IS_ACTIVE)
}, MaterialTabs.prototype.resetPanelState_ = function() {
    for (var e = 0; e < this.panels_.length; e++) this.panels_[e].classList.remove(this.CssClasses_.IS_ACTIVE)
    ...
    if (!e.getAttribute("data-upgraded")) {
        var s = document.createElement("span");
        s.classList.add(this.CssClasses_.WSK_TEXT_EXP_ICO_RIP_CONTAINER), s.classList.add(this.CssClasses_.WSK_JS_RIPPLE_EFFECT), s.classList.add(this.CssClasses_.WSK_RIPPLE_CENTER);
        var t = document.createElement("span");
        t.classList.add(this.CssClasses_.WSK_RIPPLE), s.appendChild(t), e.appendChild(s), e.setAttribute("data-upgraded", "")
    }
    ...
    if (this.element_) {
        for (var e = document.querySelectorAll(".wsk-textfield-expandable-icon"), s = 0; s < e.length; ++s) this.expandableIcon_(e[s]);
    ...
    this.element_.style.left = s.left + s.width / 2 + "px", this.element_.style.marginLeft = -1 * (this.element_.offsetWidth / 2) + "px", this.element_.style.top = s.top + s.height + 10 + "px", this.element_.classList.add(this.CssClasses_.IS_ACTIVE)
    ...
    if (this.element_) {
        ...
        s.addEventListener("mouseenter", this.handleMouseEnter_.bind(this), !1), s.addEventListener("mouseleave", this.handleMouseLeave_.bind(this))
    }
}, componentHandler.register({
    ...
    if (this.element_) {
        ...
        if (this.tabBar_) {
            var n = document.createElement("div");
            n.classList.add(this.CssClasses_.TAB_CONTAINER), this.element_.insertBefore(n, this.tabBar_), this.element_.removeChild(this.tabBar_);
            var a = document.createElement("div");
            a.classList.add(this.CssClasses_.TAB_BAR_BUTTON), a.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON), a.addEventListener("click", function() {
                this.tabBar_.scrollLeft -= 100
            }.bind(this));
            var o = document.createElement("div");
            o.classList.add(this.CssClasses_.TAB_BAR_BUTTON), o.classList.add(this.CssClasses_.TAB_BAR_RIGHT_BUTTON), o.addEventListener("click", function() {
                this.tabBar_.scrollLeft += 100
            }.bind(this)), n.appendChild(a), n.appendChild(this.tabBar_), n.appendChild(o);
            var r = function() {
                this.tabBar_.scrollLeft > 0 ? a.classList.add(this.CssClasses_.ACTIVE_CLASS) : a.classList.remove(this.CssClasses_.ACTIVE_CLASS), this.tabBar_.scrollLeft < this.tabBar_.scrollWidth - this.tabBar_.offsetWidth ? o.classList.add(this.CssClasses_.ACTIVE_CLASS) : o.classList.remove(this.CssClasses_.ACTIVE_CLASS)
            }.bind(this);
            ...
            for (var l = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), _ = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), h = 0; h < l.length; h++) new MaterialLayoutTab(l[h], l, _, this)
        }
    ...
    if ("mousedown" === e.type && this.ignoringMouseDown_) this.ignoringMouseDown_ = !1;
    else {
        ...
        if (0 === e.clientX && 0 === e.clientY) t = Math.round(n.width / 2), i = Math.round(n.height / 2);
        else {
            var a = e.clientX ? e.clientX : e.touches[0].clientX,
                o = e.clientY ? e.clientY : e.touches[0].clientY;
            t = Math.round(a - n.left), i = Math.round(o - n.top)
        }
        this.setRippleXY(t, i), this.setRippleStyles(!0), window.requestAnimFrame(this.animFrameHandler.bind(this))
    }
    ...
    if (this.element_) {
        ...
        if (!this.element_.classList.contains(this.CssClasses_.WSK_JS_RIPPLE_EFFECT_IGNORE_EVENTS)) {
            if (this.rippleElement_ = this.element_.querySelector("." + this.CssClasses_.WSK_RIPPLE), this.frameCount_ = 0, this.rippleSize_ = 0, this.x_ = 0, this.y_ = 0, this.ignoringMouseDown_ = !1, this.rippleElement_) {
                ...
                this.rippleSize_ = 2 * Math.max(s.width, s.height), this.rippleElement_.style.width = this.rippleSize_ + "px", this.rippleElement_.style.height = this.rippleSize_ + "px"
            }
